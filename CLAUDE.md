...
Current baseline: **v5.5.0 Run Recovery Console**, with **1711/1711 pytest passing**, frontend typecheck/lint passing, and frontend production build passing.
...
- Test location: `tests/`
- Framework: pytest
- Current baseline: 1711/1711 passing
