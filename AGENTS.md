...
Current baseline: **v6.7.0 Production Stability Gate**, with **full pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.7.0"`).
