...
Current baseline: **v6.6.6 Workflow Recovery & State Integrity Closure**, with **2294/2294 pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.6.6"`).
