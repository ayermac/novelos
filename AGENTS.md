...
Current baseline: **v6.6.21 LLM JSON Resilience Hotfix**, with **full pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.6.21"`).
