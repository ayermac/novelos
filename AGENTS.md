...
Current baseline: **v6.6.20 Production Ops & Release Hardening**, with **full pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.6.20"`).
