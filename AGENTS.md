...
Current baseline: **v6.6.10 API Contract & Frontend State Semantics Closure**, with **2471/2471 pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.6.10"`).
