...
Current baseline: **v6.6.7 Memory Curator Reliability Closure**, with **2320/2320 pytest passing**, frontend typecheck/lint/build/vitest passing.

Runtime version source: `novel_factory/version.py` (`__version__ = "6.6.7"`).
