...
from .title_generation import TitleGenerationMixin
from .plain_text_draft import PlainTextDraftMixin


class AuthorAgent(BaseAgent, TitleGenerationMixin, PlainTextDraftMixin):
